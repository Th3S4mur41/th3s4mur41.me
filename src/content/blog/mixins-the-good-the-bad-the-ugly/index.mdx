...
image: 'css-sass-less.jpg'
imageAlt: 'The less and SCSS logos surrounding the CSS logo'
published: true
description: >-
...
![The less and SCSS logos surrounding the CSS logo](css-sass-less.jpg)
...
Well yes, we could, but in this case we don’t need any variable parameter. So in cases where pre-processors don’t provide any advantages, _vanilla CSS_[^1] should in my opinion always be the preferred solution.

[^1]: Vanilla CSS means plain, standard CSS without frameworks (like Bootstrap) or preprocessors (like Sass).
...
![Autoprefixer logo](autoprefixer.svg)
