...
image: design-for-accessibility--make-your-product-usable-for-all.jpg
...
translations:
  - language: de
    headline: 'Featuritis: Neues Feature oder Barrierefreiheit?'
    url: https://www.fronta11y.org/featuritis-neues-feature-oder-barrierefreiheit/
...
![Diverse group of colleagues smiling in a bright office; one colleague uses a wheelchair, emphasizing inclusive teamwork. Text reads: ‘Design for accessibility — make your product usable for all.’](design-for-accessibility--make-your-product-usable-for-all.jpg)
...
<figure>
  ![Old version of Microsoft Word with toolbars that take up most of the screen making typing almost impossible and turning the search for a specific button into an adventure.](ms-word-ux.jpg)
	<figcaption>
