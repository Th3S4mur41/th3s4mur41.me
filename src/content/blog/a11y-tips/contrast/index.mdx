...
<figcaption>  
    ...
    <a href="https://codepen.io/th3s4mur41/pen/KwzRMyJ"> Open the Contrast: WCAG vs APCA demo on CodePen</a> if the embedded preview is not available.  
  </figcaption>  
</figure>  
...
<p class="codepen" data-height="400" data-default-tab="result" data-slug-hash="zxqgLYR" data-pen-title="No contrast on stacking" data-preview="true" data-user="th3s4mur41" style="height: 300px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
  ...
  on <a href="https://codepen.io">CodePen</a>.</span>
    ...
    <a href="https://codepen.io/th3s4mur41/pen/zxqgLYR">Open the No contrast on stacking demo on CodePen</a> if the embedded preview is not available.  
  </figcaption>  
</figure>  
