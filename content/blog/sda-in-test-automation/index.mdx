...
keywords:
  ...
  - DevTools Protocol
syndication:
  - https://bsky.app/profile/th3s4mur41.me/post/3mfme64gmis24
---
...
Interactive CodePen demo showing a scroll-driven animation where text fades in as the user scrolls, illustrating the challenges it poses for visual regression testing.
...
Want to go deeper on the UX rationale (not tooling) and why scroll-driven behavior can be a better fit for subtle fades like this example? Check out [Brecht De Ruyte](https://utilitybend.com/about)'s post on [CSS animation triggers](https://utilitybend.com/blog/css-animation-triggers-playing-animations-on-scroll-without-scrubbing-its-a-match).
...
<baseline-status featureId="prefers-reduced-motion"></baseline-status>
...
<baseline-status featureId="prefers-reduced-transparency"></baseline-status>
