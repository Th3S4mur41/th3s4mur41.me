...
image: 'evolution-accessibility-testing-ai-lens.jpg'
imageAlt: 'A comic-style illustration of Michaël Vanderheyden holding a futuristic digital magnifying glass with a divided lens. The left side shows standard code with green pass markers. The right side reveals a glowing purple and blue neural network overlay, symbolizing AI detecting semantic and layout issues. The entire background is solid white.'
description: >-
...
keywords:
  ...
  - WCAG 2.2
syndication:
  - https://bsky.app/profile/th3s4mur41.me/post/3mmdz2xwdac2k
  - https://www.linkedin.com/posts/michaelvanderheyden_gaad-a11y-webdev-share-7463144587767848960-jiBx
translations:
  - language: de
    headline: 'Barrierefreiheit-Testautomatisierung mit KI: Von der Analyse bis zur kontextbewussten Korrektur'
    url: https://www.fronta11y.org/barrierefreiheit-testautomatisierung-mit-ki-von-der-analyse-bis-zur-kontextbewussten-korrektur/
    publisherName: fronta11y
    publisherUrl: https://www.fronta11y.org/
---
...
<CodePen
	title="Visual Order as Reading Order"
	href="https://codepen.io/th3s4mur41/pen/QwGbawP"
  defaultTab="result"
	description="A minimal demo showing how reading-flow can align keyboard and screen‑reader navigation with the visual layout. The author info is visually placed under the heading, but semantically lives in the footer — reading-flow resolves the mismatch without changing the DOM."
/>
...
**AI doesn't just provide a fix; it provides a *harmonious* fix**. By feeding the AI the specific code snippet, the WCAG violation, and custom instructions (such as general a11y best practices or framework-specific accessibility practices), it can generate a solution that respects your existing framework, state management, and [ARIA patterns](https://www.w3.org/WAI/ARIA/apg/). It moves us from "potential fixes" to "ready-to-merge code."

> [!NOTE]
> **AI Agents and Accessibility**
>
> [Michael Fairchild](https://bsky.app/profile/mfairchild365.bsky.social) makes a very similar point in [Embedding Accessibility into AI-based software development](https://dev.to/mfairchild365/embedding-accessibility-into-ai-based-software-development-282k).
> LLMs usually do not produce accessible code by default, but output quality improves a lot when you give clear accessibility instructions.
> 
> **Practical takeaway:** if you do not bake accessibility into prompts, tooling, and review gates, AI can speed up accessibility debt just as fast as it speeds up delivery.
...
*I also wrote a German version of this post for [Global Accessibility Awareness Day (GAAD)](https://accessibility.day/) 2026 on fronta11y:  [Barrierefreiheit-Testautomatisierung mit KI: Von der Analyse bis zur kontextbewussten Korrektur](https://www.fronta11y.org/barrierefreiheit-testautomatisierung-mit-ki-von-der-analyse-bis-zur-kontextbewussten-korrektur/).*
