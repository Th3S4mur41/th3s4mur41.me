...
So here too, this feels less like a greenfield problem and more like integrating an already useful capability into the broader accessibility test flow.
...
That makes AI detection of these mismatches much more actionable. It's no longer just a warning with no good fix, but a prompt to apply a targeted, non-breaking correction.
