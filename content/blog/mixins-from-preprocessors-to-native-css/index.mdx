...
Native CSS mixins are still experimental. Full cross-browser support will take time, and today they are only available behind a flag in Chromium-based browsers. But the direction is clear.
...
It is worth following the spec now, even if you cannot ship it yet. The shift from build-time to runtime is not just a technical detail. It changes how you think about where styles live, how they update, and which tools you actually need.
